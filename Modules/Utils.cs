...
namespace TownOfHost
{
    public static class Utils
    {
        ...
        public static string GetTaskProgressText(byte playerId, bool comms = false)
        {
            ...
            var NormalColor =
                state.taskState.IsTaskFinished ? TaskCompleteColor : NonCompleteColor;
        ...
        public static string SummaryTexts(byte id, bool isForChat)
        {
            ...
            if (isForChat)
            {
                ...
                builder.Append(' ').Append(PlayerState.GetByPlayerId(id).GetPreviousRolesText().RemoveColorTags()).Append(GetTrueRoleName(id, false).RemoveColorTags());
            ...
            else
            {
                ...
                builder.Append(PlayerState.GetByPlayerId(id).GetPreviousRolesText());
