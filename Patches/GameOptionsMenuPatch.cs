...
namespace TownOfHost
{
    ...
    public static class GameOptionsMenuPatch
    {
        ...
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            tohTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources("TownOfHost-H.Resources.TabIcon.png", 100f);
