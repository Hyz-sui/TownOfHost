...
namespace TownOfHost
{
    ...
    public static class GameSettingMenuPatch
    {
        ...
        public static void StartPostfix(GameSettingMenu __instance)
        {
            ...
            var jumpToMainButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost-H.Resources.TabIcon_MainSettings.png", ref jumpButtonY, MainCategoryHeader);
            var jumpToImpButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost-H.Resources.TabIcon_ImpostorRoles.png", ref jumpButtonY, ImpostorRoleCategoryHeader);
            var jumpToCrewButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost-H.Resources.TabIcon_CrewmateRoles.png", ref jumpButtonY, CrewmateRoleCategoryHeader);
            var jumpToNeutralButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost-H.Resources.TabIcon_NeutralRoles.png", ref jumpButtonY, NeutralRoleCategoryHeader);
            var jumpToAddOnButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost-H.Resources.TabIcon_Addons.png", ref jumpButtonY, AddOnCategoryHeader);
        }
