...
namespace TownOfHost
{
    ...
    class SetEverythingUpPatch
    {
        ...
        public static void Postfix(EndGameManager __instance)
        {
            ...
            if (!Main.PutBackWinTextPosition.Value)
            {
                __instance.WinText.alignment = WinnerText.alignment = TMPro.TextAlignmentOptions.Right;
            }
            WinnerTextObject.transform.position = new(Main.PutBackWinTextPosition.Value ? __instance.WinText.transform.position.x : __instance.WinText.transform.position.x + 2.4f, __instance.WinText.transform.position.y - 0.5f, __instance.WinText.transform.position.z);
